...
export default {
    ...
    alias: ['letter'],
    category: 'valentine',
    description: 'Create a love letter effect with your image',
    ...
    async execute(sock, msg, args) {
        ...
        try {
            ...
            const url = `${API_BASE}/api/photofunia/generate?effect=love-letter&imageUrl=${encodeURIComponent(imageUrl)}`;
            ...
            await sock.sendMessage(chatId, {
                text: `❌ Failed to generate love letter effect: ${err.message}`
            }, { quoted: msg });
        }
    }
};
