...
function getMenuLocalFile() {
    const candidates = [
        path.join(process.cwd(), 'data', 'foxybot_menu_custom.gif'),
        path.join(process.cwd(), 'data', 'foxybot_menu_custom.jpg'),
        path.join(__dirname, '../menus/media/foxybot.gif'),
        path.join(__dirname, '../menus/media/foxybot.jpg'),
        path.join(__dirname, '../media/foxybot.gif'),
        path.join(__dirname, '../media/foxybot.jpg'),
    ];
...
function getMenuImageStatus() {
    ...
    const isCustomFile = localFile &&
        (localFile.includes('foxybot_menu_custom.jpg') || localFile.includes('foxybot_menu_custom.gif'));
