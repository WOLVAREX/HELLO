...
export default {
  ...
  async execute(sock, m, args) {
    ...
    //   await sock.sendMessage(jid, { 
    //     text: `⏳ *Creating Foxy Bot sticker...*\n\n📦 *Pack:* ${packName}\n👤 *By:* ${authorName}\n🎭 *Emoji:* ${emoji}` 
    //   }, { quoted: m });
      ...
      try {
        ...
        console.log(`🎨 [TOSTICKER] Adding Foxy Bot metadata...`);
        ...
        console.log(`✅ [TOSTICKER] Foxy Bot sticker sent successfully`);
        
        // Send confirmation message
        // await sock.sendMessage(jid, { 
        //   text: `✅ *Foxy Bot Sticker Created!*\n\n📦 *Pack:* ${packName}\n👤 *By:* ${authorName}\n🎭 *Emoji:* ${emoji}\n📊 *Size:* ${finalSizeKB}KB\n\n💡 *To save:*\n1. Long press sticker\n2. Tap "Add to sticker pack"\n3. It will appear under "Foxy Bot" pack`
        // }, { quoted: m });
