// ====== lib/botname.js ======
// Manages the bot's display name (e.g. "FOXY BOT").
// The name is read from bot_name.json, then environment variable BOT_NAME,
// then finally defaults to "FOXY BOT". A short 5-second in-memory cache
