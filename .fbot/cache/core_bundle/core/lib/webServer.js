...
function getStatus() {
  ...
  return {
    ...
    botName:         s.botName       || global.BOT_NAME || 'FOXY BOT',
...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  :root{
    --bg:hsl(20,100%,2%);--surface:hsl(20,100%,3%);--card:hsl(20,100%,4%);
    --neon:hsl(25,100%,55%);--neon-dim:hsl(25,90%,40%);
    --border:hsl(25,100%,25%);--border-faint:hsla(25,100%,55%,.15);
    --text:hsl(25,100%,55%);--muted:hsl(25,70%,50%);--warn:hsl(0,84%,60%);
  ...
  ::-webkit-scrollbar-track{background:hsl(20,100%,3%)}
  ::-webkit-scrollbar-thumb{background:hsl(25,100%,25%);border-radius:4px}
  ::-webkit-scrollbar-thumb:hover{background:hsl(25,100%,35%)}
  body{
    background-color:var(--bg);
    background-image:
      linear-gradient(0deg,transparent 24%,hsla(25,100%,55%,.025) 25%,hsla(25,100%,55%,.025) 26%,transparent 27%,transparent 74%,hsla(25,100%,55%,.025) 75%,hsla(25,100%,55%,.025) 76%,transparent 77%),
      linear-gradient(90deg,transparent 24%,hsla(25,100%,55%,.025) 25%,hsla(25,100%,55%,.025) 26%,transparent 27%,transparent 74%,hsla(25,100%,55%,.025) 75%,hsla(25,100%,55%,.025) 76%,transparent 77%);
  ...
  .wolf-icon{font-size:52px;line-height:1;margin-bottom:12px;filter:drop-shadow(0 0 12px var(--neon)) drop-shadow(0 0 28px hsla(25,100%,55%,.5))}
  h1{font-family:var(--font-head);font-size:30px;font-weight:900;letter-spacing:6px;text-transform:uppercase;color:#fff;text-shadow:0 0 4px var(--neon),0 0 10px hsla(25,100%,55%,.25)}
  .ver{font-size:11px;letter-spacing:3px;color:var(--muted);margin-top:6px;font-family:var(--font-mono)}
  .status-pill{display:inline-flex;align-items:center;gap:10px;padding:7px 20px;margin-top:14px;border-radius:.5rem;font-size:12px;font-weight:700;letter-spacing:2px;font-family:var(--font-mono);text-transform:uppercase;background:hsla(25,100%,55%,.06);color:var(--neon);border:1px solid var(--neon);box-shadow:0 0 14px hsla(25,100%,55%,.3),inset 0 0 14px hsla(25,100%,55%,.05);text-shadow:0 0 8px var(--neon)}
  ...
  .card{position:relative;overflow:hidden;background:hsla(25,100%,55%,.03);border:1px solid var(--border-faint);border-radius:var(--radius);padding:18px 20px;backdrop-filter:blur(12px);box-shadow:0 0 18px hsla(25,100%,55%,.08),inset 0 0 18px hsla(25,100%,55%,.02);transition:border-color .2s,box-shadow .2s}
  .card::before{content:'';position:absolute;top:0;left:0;right:0;height:1px;background:linear-gradient(90deg,transparent,hsla(25,100%,55%,.5),transparent)}
  .card:hover{border-color:hsla(25,100%,55%,.35);box-shadow:0 0 28px hsla(25,100%,55%,.18),inset 0 0 28px hsla(25,100%,55%,.03)}
  ...
  .card-value{font-size:22px;font-weight:700;color:#fff;word-break:break-word;text-shadow:0 0 10px hsla(25,100%,55%,.4);font-family:var(--font-mono)}
  .card-value.neon{color:var(--neon);text-shadow:0 0 4px hsla(25,100%,55%,.5)}
  .card-value.uptime{font-size:16px;color:#ffb060;font-variant-numeric:tabular-nums}
  ...
  .badge-on{background:hsla(25,100%,55%,.08);color:var(--neon);border:1px solid hsla(25,100%,55%,.35);text-shadow:0 0 6px var(--neon)}
  .badge-off{background:hsla(25,100%,55%,.02);color:hsl(25,30%,35%);border:1px solid hsl(25,30%,20%)}
  .platform-card{position:relative;overflow:hidden;background:hsla(25,100%,55%,.03);border:1px solid var(--border-faint);border-radius:var(--radius);padding:16px 24px;width:100%;max-width:740px;text-align:center;margin-bottom:20px;backdrop-filter:blur(12px);box-shadow:0 0 18px hsla(25,100%,55%,.08)}
  .platform-card::before{content:'';position:absolute;top:0;left:0;right:0;height:1px;background:linear-gradient(90deg,transparent,hsla(25,100%,55%,.5),transparent)}
  ...
  .plat{font-size:15px;font-weight:700;color:var(--neon);letter-spacing:1px;text-shadow:0 0 8px var(--neon),0 0 18px hsla(25,100%,55%,.3);font-family:var(--font-mono)}
  ...
  a.btn-primary{background:transparent;color:var(--neon);border:2px solid var(--neon);box-shadow:0 0 12px hsla(25,100%,55%,.3),inset 0 0 12px hsla(25,100%,55%,.05);text-shadow:0 0 8px var(--neon)}
  a.btn-primary:hover{background:hsla(25,100%,55%,.1);box-shadow:0 0 24px hsla(25,100%,55%,.5),inset 0 0 20px hsla(25,100%,55%,.1);transform:scale(1.02)}
  a.btn-ghost{background:transparent;color:hsl(25,90%,65%);border:2px solid hsl(25,60%,30%);box-shadow:0 0 10px hsla(25,100%,55%,.1)}
  a.btn-ghost:hover{border-color:hsl(25,80%,45%);color:var(--neon);box-shadow:0 0 18px hsla(25,100%,55%,.25);transform:scale(1.02)}
...
<div class="grid">
  ...
  <div class="card"><div class="card-label">// OWNER</div><div class="card-value" style="font-size:14px;color:#ffb060">+${st.owner}</div></div>
...
<footer>POWERED BY <span>FOXY TECH</span> &nbsp;//&nbsp; AUTO-REFRESH 30s</footer>
</body>
</html>`;
}
...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  :root{
    --bg:hsl(20,100%,2%);--neon:hsl(25,100%,55%);--neon-dim:hsl(25,90%,40%);
    --border-faint:hsla(25,100%,55%,.15);--muted:hsl(25,70%,50%);
  ...
  body{
    background:var(--bg);
    background-image:
      linear-gradient(0deg,transparent 24%,hsla(25,100%,55%,.018) 25%,hsla(25,100%,55%,.018) 26%,transparent 27%,transparent 74%,hsla(25,100%,55%,.018) 75%,hsla(25,100%,55%,.018) 76%,transparent 77%),
      linear-gradient(90deg,transparent 24%,hsla(25,100%,55%,.018) 25%,hsla(25,100%,55%,.018) 26%,transparent 27%,transparent 74%,hsla(25,100%,55%,.018) 75%,hsla(25,100%,55%,.018) 76%,transparent 77%);
  ...
  header{
    ...
    background:hsla(25,100%,55%,.03);flex-shrink:0
  }
  ...
  .live-pill{
    ...
    background:hsla(25,100%,55%,.06);border:1px solid hsla(25,100%,55%,.3);
  ...
  .btn-scroll{background:hsla(25,100%,55%,.06);color:var(--neon);border-color:var(--neon-dim)}
  .btn-scroll:hover{background:hsla(25,100%,55%,.15);border-color:var(--neon)}
  .btn-back{background:transparent;color:var(--muted);border-color:hsl(25,30%,22%);text-decoration:none;display:inline-flex;align-items:center;padding:6px 14px;font-size:10px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;font-family:var(--font-mono);border-radius:.5rem}
  ...
  .line:hover{background:hsla(25,100%,55%,.04)}
...
export function setupWebServer() {
  ...
  return new Promise((resolve) => {
    ...
    _server.listen(PORT, '0.0.0.0', () => {
      ...
      const title = '〔 🐺 FOXY BOT CONTROL CORE 〕';
      const inner = 42;
